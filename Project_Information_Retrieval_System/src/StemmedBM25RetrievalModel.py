...
class StemmedBM25RetrievalModel:

    def __init__(self):
        #  create_corpus()

        self.results_folder = BM25_RESULTS_FOLDER
        self.corpus_folder = STEMMED_CORPUS
        ...
        self.queries_list = get_stem_queries()
        self.token_count = {}
        self.inverted_index_file = None
        self.inverted_index_data_dict = None

    def load_index_file(self):
        self.inverted_index_data_dict = get_stemmed_inverted_index()
