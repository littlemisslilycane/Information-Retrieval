...
public class Task1 {
  ...
  public static void main(String[] args) throws IOException {
    ...
    String[] queryList = {"earth observation", "artificial satellites", "space " +
            "telescopes", "observation satellites", "observation satellite", "space station"};
    try {
      s = "BFS_PARSED";
    ...
    for (String query : queryList) {
      ...
      File fWrite = new File(query + ".txt");
